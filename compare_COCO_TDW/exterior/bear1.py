...
class ProcGenInteriorDesign(Controller):
    ...
    def run(self):
        ...
        self.add_object(model_name='b03_325_bear',
                        position={"x": 0.7, "y": 0.0001, "z": 0},
                        rotation={"x": 0, "y": 0, "z": 0},
                        library="models_full.json")

        position = TDWUtils.get_random_point_in_circle([0, 0, 0], 3)
        obj = self.add_object(model_name='b03_realistic_pigeon_max',
                              position=TDWUtils.array_to_vector3(position),
                              rotation={"x": 0, "y": 70, "z": 0},
                              library="models_full.json")

        self.communicate({"$type": "scale_object",
                          "scale_factor": {"x": 1.75, "y": 1.75, "z": 1.75},
                          "id": obj})

        position = TDWUtils.get_random_point_in_circle([0, 0, 0], 3.5)
        obj = self.add_object(model_name='b03_realistic_pigeon_max',
                              position=TDWUtils.array_to_vector3(position),
                              rotation={"x": 0, "y": 0, "z": 0},
                              library="models_full.json")
        ...
        position = TDWUtils.get_random_point_in_circle([0, 0, 0], 2.5)
        obj = self.add_object(model_name='b03_realistic_pigeon_max',
                              position=TDWUtils.array_to_vector3(position),
        ...
        position = TDWUtils.get_random_point_in_circle([0, 0, 0], 3.8)
        obj = self.add_object(model_name='b03_realistic_pigeon_max',
                              position=TDWUtils.array_to_vector3(position),
                              rotation={"x": 0, "y": 30, "z": 0},
                              library="models_full.json")
        ...
        TDWUtils.save_images(images, "bear1",

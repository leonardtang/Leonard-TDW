...
class ProcGenInteriorDesign(Controller):
    ...
    def run(self):
        ...
        # Add the avatar.
        self.communicate(TDWUtils.create_avatar(position={"x": 2.5, "y": 1.5, "z": 0.3},
        ...
        self.communicate({"$type": "add_material", "name": "gravel_white", "url": record.get_url()})
        self.communicate({"$type": "set_proc_gen_floor_material", "name": "gravel_white"})
        ...
        TDWUtils.save_images(images, "bench_ball",

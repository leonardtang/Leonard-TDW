...
class ProcGenInteriorDesign(Controller):
    ...
    def run(self):
        ...
        self.communicate({"$type": "rotate_hdri_skybox_by", "angle": 60})
        ...
        #
        # self.add_object(model_name="736684_elephant",
        #                 position={"x": -5, "y": 0.0001, "z": -4},
        #                 rotation={"x": 0, "y": -90, "z": 0},
        #                 library="models_full.json")

        self.add_object(model_name="688926_elephant",
                        position={"x": 1.2, "y": 0.0001, "z": 3},
                        rotation={"x": 0, "y": 13, "z": 0},
                        library="models_full.json")

        self.add_object(model_name="703464_elephant",
                        position={"x": 3, "y": 0.0001, "z": -2},
                        rotation={"x": 0, "y": -95, "z": 0},
                        library="models_full.json")

        self.add_object(model_name="b03_zebra",
                        position={"x": -4, "y": 0.0001, "z": 0.7},
                        rotation={"x": 0, "y": -80, "z": 0},
                        library="models_full.json")

        bird = self.add_object(model_name="polysurface63",
                               position={"x": 1, "y": 3.5001, "z": 0.7},
                               rotation={"x": 0, "y": -80, "z": 0},
                               library="models_full.json")
        ...
        TDWUtils.save_images(images, "elephants1",

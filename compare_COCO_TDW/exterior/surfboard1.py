...
class ProcGenInteriorDesign(Controller):
    ...
    def run(self):
        ...
        # Add the avatar.
        self.communicate(TDWUtils.create_avatar(position={"x": 0, "y": 1.6, "z": 0},
                                                look_at=TDWUtils.array_to_vector3([0.5, 1.5, 0]),
                                                avatar_id="avatar"))
        ...
        self.communicate({"$type": "add_material", "name": "iceland_black_sand_beach", "url": record.get_url()})
        ...
        scene_data = self.communicate({"$type": "look_at_position",
                                       "avatar_id": "avatar",
                                       "position": TDWUtils.array_to_vector3([0.5, 1.5, 0])})

        images = Images(scene_data[0])
        TDWUtils.save_images(images, "surfboard1",

...
class ProcGenInteriorDesign(Controller):
    ...
    def run(self):
        ...
        position = [0.2 + np.random.uniform(-0.1, 0.1), 0.8, 1.8 + np.random.uniform(-0.1, 0.1)]
        ...
        TDWUtils.save_images(images, "dog_bed", output_directory="replicated_images/interior")

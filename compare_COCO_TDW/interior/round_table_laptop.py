...
class ProcGenInteriorDesign(Controller):
    ...
    def run(self):
        ...
        # Add the avatar.
        self.communicate(TDWUtils.create_avatar(position={"x": -1, "y": 1.9, "z": 0},
        ...
        self.add_object(model_name="macbook_air",
        ...
        self.add_object(model_name="b04_bottle_max",
                        position={"x": 0.4, "y": top[1], "z": 0},
                        library="models_full.json")

        self.add_object(model_name="b04_nozhnitsy",
                        position={"x": 0.3, "y": top[1], "z": 0.4},
                        library="models_full.json")
        ...
        TDWUtils.save_images(images, "round_table_laptop", output_directory="replicated_images")

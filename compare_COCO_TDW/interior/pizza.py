...
class ProcGenInteriorDesign(Controller):
    ...
    def run(self):
        ...
        # Add the avatar.
        self.communicate(TDWUtils.create_avatar(position={"x": 1.6, "y": 1.6, "z": 0.35},
                                                look_at=TDWUtils.array_to_vector3([3, 0.5, 0.35]),
                                                avatar_id="avatar"))
        ...
        TDWUtils.save_images(images, "pizza", output_directory="replicated_images")

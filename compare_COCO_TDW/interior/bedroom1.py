...
class ProcGenInteriorDesign(Controller):
    ...
    def run(self):
        ...
        # Add the avatar.
        self.communicate(TDWUtils.create_avatar(position={"x": 3, "y": 1.7, "z": 2},
                                                look_at={"x": 0, "y": 0.8, "z": 2},
                                                avatar_id="avatar"))
        ...
        TDWUtils.save_images(images, "bedroom1", output_directory="replicated_images")
